...
st.markdown("# Interests Discovery Quiz")
st.sidebar.header("Interests Discovery Quiz")
placeholder1 = st.empty()
placeholder1.write("This Interests Discovery quiz will take about 3-5 minutes to complete")
st.write("Sample discovery question")
color = st.select_slider(
    'How are you feeling?',
    options=['☀️ Sunny days ☀️', '⬅️ Choose ➡️', '🌧️ Rainy days 🌧️'], value='⬅️ Choose ➡️')
...
with st.form(key='interest_profiler'):
	...
	st.write("Please choose the statement that you agree with by moving the dot on the slider to right or left")
